...
async function captureCodeToImage() {
  try {
    ...
    await page.addStyleTag({ url: 'https://cdnjs.cloudflare.com/ajax/libs/github/11.3.1/github.min.css' });
    ...
    const savePath = path.join(vscode.workspace.rootPath || process.cwd(), 'Downloads', filename);
...
function activate(context) {
  ...
  let disposable = vscode.commands.registerCommand('extension.convertCodeToImage', () => {
    captureCodeToImage();
  });
